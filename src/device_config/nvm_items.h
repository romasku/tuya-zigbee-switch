...
#define NV_ITEM_COVER_CONFIG(cover_idx)                                                    \
        (NV_ITEM_BASIC_CLUSTER_DATA + MAX_SWITCHES + MAX_RELAYS + MAX_COVER_SWITCHES + 1 + \
         cover_idx)
#define NV_ITEM_SWITCH_LONG_CLUSTER_DATA(switch_idx)                                   \
        (NV_ITEM_BASIC_CLUSTER_DATA + MAX_SWITCHES + MAX_RELAYS + MAX_COVER_SWITCHES + \
         MAX_COVERS + 1 + switch_idx)

// 3 + 5 (switches) + 5 (relays) + 3 (cover switches) + 3 (covers) + 5 (long-press) = 24
