...
static inline hal_zigbee_cmd build_level_step_cmd(uint8_t endpoint, uint8_t dir,
                                                  uint8_t step_size) {
...
static inline hal_zigbee_cmd build_color_temp_step_cmd(uint8_t endpoint, uint8_t dir,
                                                       uint8_t step_size) {
