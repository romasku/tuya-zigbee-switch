...
|`zha/`           | Quirks to support devices to ZHA <br> (generated by `make quirks`) |
|`zigbee2mqtt/`   | Converters to support devices in Z2M + OTA indexes <br> (generated by `make converters`) |
